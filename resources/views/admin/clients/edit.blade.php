...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div>
        <h1 class="page-title">تعديل: {{ $client->name_en }}</h1>
    </div>
    ...
    <div class="panel-card-body">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="name_ar" value="{{ old('name_ar', $client->name_ar) }}"
            ...
            <div class="col-md-6">
                ...
                @if($client->logo)
                <div class="mb-2">
                    <img src="{{ asset($client->logo) }}" alt="" class="img-thumbnail" style="max-height:60px;">
                </div>
                @endif
            ...
            <div class="col-md-3">
                ...
                <input type="url" name="website_url" value="{{ old('website_url', $client->website_url) }}" class="form-control">
            </div>
            <div class="col-md-2">
                <label class="form-label">الترتيب</label>
                <input type="number" name="sort_order" value="{{ old('sort_order', $client->sort_order) }}" class="form-control" min="0">
            </div>
            <div class="col-md-1">
